...
if ($datumda == 0 ) {
	$spruch = "SELECT * FROM liga_spiel WHERE wettkampf_id = $wettkampfid AND spieltag = $spieltag";
	...
	echo "<FORM METHOD=\"post\" NAME=\"cc\" ACTION=\"CC-Finale.php\">";
	echo "<TABLE>";
	echo "<TR>";
	...
	for($i=0;$i<(count($mannschaften)/2);$i++)
	{
		...
		echo "<input type=\"hidden\" NAME=\"gast_$i\" VALUE=\"${mannschaften[$i+1]}\">";
